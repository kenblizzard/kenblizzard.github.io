...
const onePageScroll = function (element, options) {
    ...
    const _responsive = function () {
        ...
        if (document.body.clientWidth < settings.responsiveFallback) {
            ...
            _swipeEvents(el);
            document.removeEventListener("swipeDown", null);
            document.removeEventListener("swipeUp", null);
    ...
    self.moveTo = function (el5, page_index) {
